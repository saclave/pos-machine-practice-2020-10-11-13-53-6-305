...
public class PosMachine {
    ...
    public String printReceipt(List<String> barcodes) {
        ...
        checkBarcodes(barcodes, itemInfos);
        return generateFinalReceipt(itemDetail, finalTotal);
    }

    private void checkBarcodes(List<String> barcodes, List<ItemInfo> itemInfos) {
        ...
        for(String barcode : barcodes) {
            ...
            item = getItemInfo(itemInfos, barcode);
    ...
    private String generateFinalReceipt(String receipt, int finaltotal) {
        return "***<store earning no money>Receipt***" + space + receipt + "----------------------" + space +
                "Total: " + finaltotal + " (yuan)"+ space + "**********************";
    }

    private ItemInfo getItemInfo(List<ItemInfo> itemInfos, String barcode) {
